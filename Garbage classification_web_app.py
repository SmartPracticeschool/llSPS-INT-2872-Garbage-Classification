...
def home():
    ...
    return render_template('Garbage_model.html')
        ...
        try:
            if file and allowed_file(file.filename):
                ...
                if class_prediction[0] == 0:
                  ...
                  product = "some other Garbage"
                return render_template('Garbage classification.html', product = Garbage_Name, user_image = file_path)
        except Exception as e:
            return "Unable to read the file. Please check if the file extension is correct."

    return render_template('Garbage classification.html')
